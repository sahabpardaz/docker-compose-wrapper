...
public class DockerCompose extends ExternalResource {
    ...
    public static class BuilderStage {
         ...
         * less time starting up your environment each time.<br> Note that this option uses previous existing volumes of
         * this docker image. So, state of previous container may be present in the new one by default. Users will need
         * to renew the state manually.
         */
         ...
         * those services started by this test (provided that they don't enable {@link #forceRecreate()} without paying
         * their startup times so in overall your tests will take less time. This even applies to running tests several
         * times, since after your tests finished running, the next file of your tests will use the previous started
         * services.
         * </p>
         */
        ...
        /**
         * Sets a different project name than the default one (which is the directory of your compose file). The
         * container name of a service is the combination of its project name + it services name.
         */
